...
export default function Home() {
    const { blogEntries, settings } = usePage<SharedData>().props;
...
<section className="py-20 bg-background">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid lg:grid-cols-2 gap-12">
						...
						<h4 className="text-2xl font-semibold text-primary mb-2">Vores Mission</h4>
							<p>
            ...
            {/* Video Section */}
            <section className="py-20 bg-arctic-gradient">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-2xl p-8 border border-primary/20 mb-8">
                            ...
                            <p className="text-foreground/90 leading-relaxed mb-4">
                                Forskning viser, at natur, friluftsliv og bevægelse blandt andet gør børn og unge mere robuste, øger
                                selvværdet og reducerer stress. Desuden medfører det et sundere og stærkere immunforsvar, bedre motorisk
			...
			<section className="py-24 bg-arctic-gradient">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-20">
            ...
            {/* CTA Section */}
            <section className="py-24 bg-arctic-hero relative overflow-hidden">
